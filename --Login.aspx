				...
				<TR>
				  <TD>
						<TABLE height="238" cellSpacing="0" cellPadding="0" align="right" border="0" 
							...
							<TR>
								<TD align="center" width="400" colSpan="2" height="47"><asp:button id="ButLogin" runat="server" Text="登 录" Font-Size="9pt" CssClass="button" onclick="ButLogin_Click"></asp:button>&nbsp;&nbsp;<asp:button id="ButRegist" runat="server" Text="注 册" CausesValidation="False" Font-Size="9pt"
										Enabled="False" CssClass="button"></asp:button></TD>
							</TR>
							<TR>
								<TD align="center" width="400" colSpan="2" height="58"><p>&nbsp;</p>
							    <p><font face="宋体">提示：为使系统正常运行，请暂时关闭拦截弹出窗口工具。</FONT></p></TD>
							</TR>
					</TABLE>
				        <p>
